...
const EditAddress = () => {
    ...
    const PostData = async (e) => {
        ...
        if(addressLine1 && addressLine2 && cityName && district && state && zipCode){
                        ...
                        <form method="post" className="needs-validation" novalidate="" onSubmit={PostData}>
                            <div className="row g-3">
                                ...
                                <div className="col-12">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="5678 Main St" required name="addressLine1" value={address.addressLine1} onChange={handleInputs}/>
