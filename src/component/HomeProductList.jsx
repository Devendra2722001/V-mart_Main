    ...
    <>
      ...
      <div className="Mobile-list-Line">
        <div className="Mobile-list-Line-text">
          ...
          <div className="Mobile-list-Line-Viewall"><NavLink to={`/mobile`} id="copyright">View All</NavLink></div>
        </div>
      ...
      <div className="Mobile-list-Line">
        <div className="Mobile-list-Line-text">
          ...
          <div className="Mobile-list-Line-Viewall"><NavLink to={`/laptop`} id="copyright">View All</NavLink></div>
        </div>
        <section className="mini-wrapper">
      ...
      <div className="Mobile-list-Line">
        <div className="Mobile-list-Line-text">
          ...
          <div className="Mobile-list-Line-Viewall"><NavLink to={`/shoes`} id="copyright">View All</NavLink></div>
        </div>
        <section className="mini-wrapper">
