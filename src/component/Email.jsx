    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        ...
        <div  class="col-md-8 col-lg-6 col-xl-4">
            ...
            <input type="text" class="form-control" placeholder="enter email id" name="emailID" value={email.emailID} onChange={handleInputs} />
            {error.email && <span className='text-danger font-weight-bold'>{error.email}</span>}
        <br></br>
        <NavLink to="/ResetPassword">
            <button class="btn btn-primary profile-button" type="button" onClick={SendOTP}>Send OTP</button>
        </NavLink>
        </div>
    </div>
  )
