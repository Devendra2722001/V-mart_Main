                    ...
                    <div className="cart-card-container" key={cartObj._id}>
                        <div>
                            <div className="cart-card">
                                <img src={cartObj.productImageurl} alt="images" className="cart-card-media" />
                                <div className="cart-card-text">
                                    <div className="cart-card-head"> {cartObj.productName} </div>
                                    <div className="cart-card-price">Price - {cartObj.productPrice}/-₹</div>
                                    <div class="cart-lastrow">
                                        <div className="cart-card-category">Category - {cartObj.productCategory}</div>
                                    </div>
                                    <div>
                                        <p className="lead">
                                            {cartObj.quantity} X {cartObj.productPrice} = {cartObj.quantity * cartObj.productPrice}
                                        </p>
                                    </div>
                                    <button type="button" className="btn btn-danger" onClick={() => {removeFromCart(cartObj.productId);}}>Remove</button>
