        ...
        <div>
              <div className="Filters">
                <div className="Filter_Card" id="Filter_Card_first">
                  ...
                  <div >                    
                    <button className="btn btn-outline" id ="filter_btn" onClick={() => filter1Product("4")}>4 GB</button>                                        
                  </div>

                  <div >                    
                    <button className="btn btn-outline" id ="filter_btn" onClick={() => filter1Product("6")}>6 GB</button>                                        
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter1Product("8")}>8 GB</button>                      
                  </div>
                ...
                <div className="Filter_Card">
                  ...
                  <div >
                      <button className="btn btn-outline" id ="filter_btn_first" onClick={() => filter2Product("Oppo")}>Oppo</button>                                        
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Iphone")}>Iphone</button>                                           
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Samsung")}>Samsung</button>                      
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Google")}>Google</button>                      
                  </div>

                </div>

                 <div>
                      <button className="btn btn-outline" id ="filter_btn_reset" onClick={() => filterProduct("mobile")}>Reset</button>
                  </div>
              </div>
          </div>
