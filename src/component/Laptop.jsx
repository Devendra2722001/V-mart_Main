        ...
        <div>
              <div className="Filters">
                <div className="Filter_Card" id="Filter_Card_first">
                  ...
                  <div >
                      <button className="btn btn-outline" id ="filter_btn_first" onClick={() => filter1Product("8GB")}>8 GB</button>                                        
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter1Product("16GB")}>16 GB</button>                                           
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter1Product("32GB")}>32 GB</button>                      
                  </div>
                ...
                <div className="Filter_Card">
                  ...
                  <div >
                      <button className="btn btn-outline" id ="filter_btn_first" onClick={() => filter2Product("Apple_L")}>Apple</button>                                        
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Rog")}>Rog</button>                                           
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Hp")}>Hp</button>                      
                  </div>

                  <div>                      
                      <button className="btn btn-outline" id ="filter_btn" onClick={() => filter2Product("Msi")}>Msi</button>                      
                  </div>

                </div>

                 <div>
                      <button className="btn btn-outline" id ="filter_btn_reset" onClick={() => filterProduct("laptop")}>Reset</button>
                  </div>
              </div>
          </div>
